...
<head>
  ...
  <title>УПРАВЛЕНИЕ САЙТОМ - {$lang['skin_title']}</title>
...
<nav class="navbar navbar-default navbar-inverse navbar-static-top" role="navigation">
  <div class="navbar-header">
    <a class="navbar-brand" href="?mod=main">EASY - УПРАВЛЕНИЕ САЙТОМ</a>
...
<!--MAIN area-->
	...
	<div class="login box" style="margin-top: 100px;">
      ...
      <div class="box-header">
        <span class="title">{$lang['skin_title']} УПРАВЛЕНИЕ САЙТОМ</span>
      </div>
